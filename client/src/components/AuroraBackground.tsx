    ...
    <div ref={wrapRef}>
      ...
      <div
        ...
        style={{
          ...
          height: "700px",
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(59,130,246,0.18) 0%, rgba(37,99,235,0.08) 40%, transparent 70%)",
          filter: "blur(60px)",
      ...
      <div
        ...
        style={{
          ...
          height: "600px",
          borderRadius: "50%",
          background: "radial-gradient(circle, rgba(240,68,68,0.14) 0%, rgba(185,28,28,0.06) 40%, transparent 70%)",
          filter: "blur(70px)",
